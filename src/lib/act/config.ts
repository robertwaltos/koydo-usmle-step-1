// Auto-generated shim — re-exports from @/lib/usmle-step-1/config
// This lets shared ecosystem components import from "@/lib/act/config"
import type { ExamConfig as UsmleStep1Config } from "@/lib/usmle-step-1/config";
import { EXAM_CONFIG as _raw } from "@/lib/usmle-step-1/config";

type RawExamConfig = UsmleStep1Config & {
  category?: string;
  locale?: string;
  isRTL?: boolean;
