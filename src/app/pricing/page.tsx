...
export const metadata: Metadata = {
  title: "Pricing — Usmle Step 1 Premium",
  description: "Unlock unlimited Usmle Step 1 practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=usmle-step-1&cadence=annual`;
